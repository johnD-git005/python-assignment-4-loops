...
print("USING FOR LOOP TO ITERATE THROUGH THE STUDENTS RECORD")
...
for student in students:
	if student['score'] >= 70 and student['score'] <= 100:
		print(f"ID: {student['id']}, Name: {student['name']}, Score: {student['score']}")

print("\n AVERAGE PERFORMERS")

for student in students:
	if student['score'] >= 50 and student['score'] <= 69:
		print(f"ID: {student['id']}, Name: {student['name']}, Score: {student['score']}")

print("\n LOW PERFORMERS")

for student in students:
	if student['score'] >= 0 and student['score'] <= 49:
		print(f"ID: {student['id']}, Name: {student['name']}, Score: {student['score']}")

print("\n ASSIGNING `student_id` AS THE key AND A tuple `(name, score)` AS THE value")
...
for student in students:
	...
	if student['score'] >= 70 and student['score'] <= 100:
		high_performers[student_id] = (student_name, student_score)

	elif student['score'] >50 and student['score'] <= 69:
		average_performers[student_id] = (student_name, student_score)

	elif student['score'] >= 0 and student['score'] <= 49:
		low_performers[student_id] = (student_name, student_score)
...
print("\n TO PRINT THE NUMBER OF STUDENTS IN EACH CATEGORY AS A SUMMARY REPORT")

print(f"\n TOTAL NUMBER OF HIGH PERFORMERS: {len(high_performers)}")
print(f"TOTAL NUMBER OF AVERAGE PERFORMERS: {len(average_performers)}")
print(f"TOTAL NUMBER OF LOW PERFORMERS: {len(low_performers)}")

print('')

print("\n TO PRINT EACH CATEGORY(3)")

print("\n HIGH PERFORMERS")

for student_id in high_performers:
	student_name, student_score = high_performers[student_id]
	print(f"ID: {student_id}, NAME: {student_name}, SCORE: {student_score}")

print("\n AVERAGE PERFORMERS")

for student_id in average_performers:
	student_name, student_score = average_performers[student_id]
	print(f"ID: {student_id}, NAME: {student_name}, SCORE: {student_score}")

print("\n LOW PERFORMERS")

for student_id in low_performers:
	student_name, student_score = low_performers[student_id]
	print(f"ID: {student_id}, NAME: {student_name}, SCORE: {student_score}")
